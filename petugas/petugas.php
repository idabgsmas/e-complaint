...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="homepetugas.php">
        <div class="sidebar-brand-icon">
          <img src="../desamas.png" height="50" width="50">
        </div>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h1 class="text-primary font-weight-bold" style="margin-top: 10px; margin-left: 10px; font-size: 30px;">Selamat Datang <b>PETUGAS!</b></h1>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <?php include 'halamanpetugas.php'; ?>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Gusmasdev2021</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
